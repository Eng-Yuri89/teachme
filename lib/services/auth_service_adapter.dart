...
class AuthServiceAdapter implements AuthService {
  ...
  @override
  Future<User> signInWithPhoneNumber(String verificationId, String otp) =>
      authService.signInWithPhoneNumber(verificationId, otp);

  @override
  Future<void> verifyPhoneNumber(
          String phoneNumber, Function(String p1, [int p2]) smsOTPSent) =>
      authService.verifyPhoneNumber(phoneNumber, smsOTPSent);
}
